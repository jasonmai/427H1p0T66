...
a <- c(23.725735203770004, -11.121721844970006, 1, -306.5419104660798, 1.6559377264800008, 0.96036351943, 1, -69.76208416239015, -6.71243858593, -1.83248068719, 4.67086975429, -38.65585033583998)
# for (iter in 1:12){
#   a <- rep(0, 12)
#   a[2] <- 1
#   a[11] <- 1
...
output_params <- output_params(a,2)
